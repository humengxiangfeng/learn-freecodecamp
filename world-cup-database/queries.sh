...
echo "$($PSQL "SELECT DISTINCT(name) FROM teams as t FULL JOIN games as g on t.team_id = g.winner_id OR t.team_id = g.opponent_id WHERE year = 2014 AND g.round = 'Eighth-Final'")"
